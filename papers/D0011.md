...
| Path           | Start           | Relative Path     | Proximate Path    |
|:---------------|-----------------|-------------------|-------------------|
| `"/a/d"`       | `"/a/b/c"`      | `"../../d"`       | `"../../d"`       |
| `"/a/b/c"`     | `"/a/d"`        | `"../b/c"`        | `"../b/c"`        |
| `"/a/b/c"`     | `"/a/b"`        | `"./c"`           | `"./c"`           |
...
| Path               | Start              | Relative             | Lexically Relative         |
|:-------------------|--------------------|----------------------|----------------------------|
| `"a/b/c/testdir"`  | `"x/y/z"`          | `"../b/c/testdir"`   | `"../../../a/b/c/testdir"` |
| `"a/b/c/testdir"`  | `"m/n"`            | `"./b/c/testdir"`    | `"../../a/b/c/testdir"`    |
| `"m/n"`            | `"a/b/c/testdir"`  | `"../../.."`         | `"../../../../m/n"`        |
| `"a/d/e"`          | `"a/b/c/testdir"`  | `"../.."`            | `"../../../d/e"`           |
| `"a/d"`            | `"a/b/c/testdir"`  | `"../../../d"`       | `"../../../d"`             |
| `"a/d/e"`          | `"x/y"`            | `"../../a/b"`        | `"../../a/d/e"`            |
| `"x/y"`            | `"a/d/e"`          | `"../../x/y"`        | `"../../../x/y"`           |
...
> Note, if `Start` exists the implied assumption is that `Start` is `canonical( OriginalStart )` so that the `normalize()` operation only affects `RelPath`. This issue is discussed at length in section [4.2.6 Just Working](#326-just-working) however in general the above assumption serves as an accurate mental model of the expected semantics.
